...
public class RecyclerView_Category_dual_display extends RecyclerView.Adapter<RecyclerView_Category_dual_display.ViewHolder> {
    ...
    public RecyclerView_Category_dual_display(Context context, ArrayList<String> mainimg, ArrayList<String> subimg, ArrayList<String> name, ArrayList<String> des, ArrayList<String> loc, ArrayList<String> category) {
        mainimgs = mainimg;
        subimgs = subimg;
        names = name;
        dess = des;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cardview_category_dual_display, parent, false);
