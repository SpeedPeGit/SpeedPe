...
public class RecyclerView_Profile_Post extends RecyclerView.Adapter<RecyclerView_Profile_Post.ViewHolder> {
    ...
    public RecyclerView_Profile_Post(Context context,ArrayList<String> mImageUrl,ArrayList<String> sImageUrl,ArrayList<String> summary) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate( R.layout.fragment_profile_post_frame, parent, false);
...
/*        Glide.with(mContext)
        ...
        holder.card_single_img.setVisibility(View.GONE);
