...
public class SwipedeleteActivity extends AppCompatActivity implements RecyclerItemTouchHelper.RecyclerItemTouchHelperListener {

    private static final String TAG = SwipedeleteActivity.class.getSimpleName();
